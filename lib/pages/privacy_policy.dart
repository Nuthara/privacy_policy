...
class _PrivacyPolicyState extends State<PrivacyPolicy> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: BackMenu(
        title:"Privacy Policy", onMenuPressed: () {  },
      ),
      body: SingleChildScrollView(
        padding: const EdgeInsets.all(20),
        child: Column(
          children: [
            const Text("What is the Privacy Policy and what does it cover?",
            style:TextStyle(
              fontSize: 20,
            ...
            Container(
              margin:const EdgeInsets.only(top: 10,bottom: 5),
              child: const Text("Welcome to the NSBM N-Side app. We are committed to protecting your privacy and providing a secure and seamless experience. This Privacy Policy outlines how we collect, use, disclose, and protect your personal information. By using the App, you consent to the practices described in this policy.",
              style: TextStyle(
                fontSize: 17,
                fontWeight: FontWeight.normal,
              ),
            ...
            Container(
              margin:const EdgeInsets.only(top: 10,bottom: 5),
              child: const Text("Information We Collect",
              style: TextStyle(
                fontSize: 17,
                fontWeight: FontWeight.bold,
              ),
            ...
            Container(
              margin:const EdgeInsets.only(top: 10,bottom: 5),
              child: const Text("We collect the following types of information when you use our App:",
              style: TextStyle(
                fontSize: 17,
                fontWeight: FontWeight.normal,
              ),
          ...
          Container(
              margin:const EdgeInsets.only(top: 10,bottom: 5),
              child: const Text(" How We Use Your Information",
              style: TextStyle(
                fontSize: 17,
                fontWeight: FontWeight.bold,
              ),
            ...
            Container(
              margin:const EdgeInsets.only(top: 10,bottom: 5),
              child: const Text("We use the collected information for the following purposes:",
              style: TextStyle(
                fontSize: 17,
                fontWeight: FontWeight.normal,
              ),
